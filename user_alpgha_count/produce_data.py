...
points_list = [
    # 7 个簇中心
    generate_points(100, 0, 0, 1),
    generate_points(100, 3, 5, 2),
    #generate_points(10, 5, 20, 5),
    generate_points(100, 5, 20, 3),
    #generate_points(10, 10, 2, 4),
    generate_points(100, 10, 2, 3),
    generate_points(100, 10, 10, 3),
    generate_points(100, 15, 20, 3),
    generate_points(100, 20, 10, 3),
]
